...
public class AuthService {
    ...
    public TokenDTO login(CredenciaisDTO dto){
        // Essa linha verifica se o usuário é identico/pertence a aplicação/possui acesso
        // O usuário só será autenticado se passar dessa linha abaixo (email e senha corretas)
    ...
    private String getPerfil(Collection<? extends GrantedAuthority> authorities){
        ...
        for(GrantedAuthority authority : authorities){
            perfil = authority.getAuthority(); // ROLE...
        }
