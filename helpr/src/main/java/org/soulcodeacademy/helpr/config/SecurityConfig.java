...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .anyRequest().authenticated(); // bloqueando outros endpoints, precisa passar o token para acessar
        // Aqui indicamos que não há sessão de usuário (armazenamento no cookies), apenas o JWT garante que o usuário possui autorização para acessar
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        //configuration.addAllowedOrigin("http://localhost:4200"); -> Permitindo só uma aplicação acessar a api
        ...
        // /funcionarios
        // /chamados
        // /** -> permite acessar qualquer origem
